# Week 12: Final Demonstration and Job-Ready Portfolio

## Teaching Purpose
Present a coherent application and defend the engineering decisions, verification, and operational limits behind it.

## Entry Check
Bring the production repository, deployment/release record, incident exercise, workflow SOP, and interview feedback. Freeze feature scope before rehearsing; prioritize broken core behavior and evidence gaps.
...
Use the teaching topics below during pre-demo rehearsal, not as a 75-minute lecture on presentation day. Final session: 10m framing, 15m instructor example, 140m student presentations, and 15m feedback/next steps. For up to 14 students, allocate 7m demonstration and 3m questions each. For larger cohorts, use parallel review groups and collect recordings; publish the grouping and ensure each student receives instructor feedback. The assignment is in [homework.md](homework.md).

## Rehearsal Teaching Topics
